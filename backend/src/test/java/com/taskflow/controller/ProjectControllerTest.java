...
// .build();
// project = new
// Project(UUID.fromString("b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11"),
// "Test Project",
// "Description",
...
// CreateProjectRequest request = new CreateProjectRequest("New Project", "New
// Desc",
// Arrays.asList(UUID.fromString("c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11")));
// Project createdProject = new
// Project(UUID.fromString("d0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11"),
// "New Project",
// "New Desc",
// Arrays.asList(manager),
// manager);

// when(projectService.createProject(any(Project.class), any(UUID.class),
...
// when(projectService.getProjectById(UUID.fromString("e0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11")))
// .thenReturn(Optional.empty());

// mockMvc.perform(get("/api/projects/{projectId}",
// UUID.fromString("e0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11")))
// .andExpect(status().isNotFound());
// }

// @Test
// void updateProject_success() throws Exception {
// CreateProjectRequest request = new CreateProjectRequest("Updated Project",
// "Updated Desc",
// null);
...
// CreateProjectRequest request = new CreateProjectRequest("", "Updated Desc",
// null); // Empty
// // name
...
// Project(UUID.fromString("e0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11"),
// "Project 2",
// "Desc 2",
// Arrays.asList(user2),
// user2);
