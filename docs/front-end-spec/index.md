...
- [TaskFlow UI/UX Specification](#table-of-contents)
  ...
  - [User Flows](./user-flows.md)
      - [Onboarding: Registration & Login](./user-flows.md#onboarding-registration-login)
      - [Core Task Management: Create, View, and Update Tasks](./user-flows.md#core-task-management-create-view-and-update-tasks)
  ...
  - [Component Library / Design System](./component-library-design-system.md)
      ...
      - [Core Components to be Utilized](./component-library-design-system.md#core-components-to-be-utilized)
  ...
  - [Animation & Micro-interactions](./animation-micro-interactions.md)
      ...
      - [Key Animations & Micro-interactions](./animation-micro-interactions.md#key-animations-micro-interactions)
